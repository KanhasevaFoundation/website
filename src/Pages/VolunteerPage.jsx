      ...
      {step === 1 && (
        <div className="transition-all duration-300">
          ...
          <div className="mb-6 flex flex-col items-center">
            <div
              className="w-32 h-32 rounded-full bg-gray-200 overflow-hidden border-4 border-sky-300 flex items-center justify-center mb-2 relative"
            ...
            <label
              ...
              className="cursor-pointer px-4 py-2 bg-sky-500 text-white rounded flex items-center hover:bg-sky-600 transition"
            >
          ...
          <div className="mb-4">
            <div className="flex items-center border border-gray-300 rounded overflow-hidden">
              <div className="bg-sky-50 w-10 h-10 p-3 text-sky-500">
                <FaUser />
              </div>
              <input
                type="text"
          ...
          <div className="mb-6">
            <label className="flex items-center">
              <input
                ...
                name="termsAccepted"
              />
              <span className="ml-2">I accept the <a href="/terms" className="text-sky-600 hover:underline">Terms and Conditions</a></span>
            </label>
